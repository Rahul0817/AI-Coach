...
AGENT_DEFINITIONS: dict[AgentName, AgentDefinition] = {
    AgentName.HEALTH_EXPERT: AgentDefinition(
        ...
        temperature=0.3,
        routing_keywords=[
            "pcos", "diagnosis", "diagnose", "rotterdam", "hormone", "hormonal",
            "androgen", "testosterone", "insulin", "ovary", "ovaries", "ovulation",
            "ultrasound", "endocrine", "syndrome", "condition", "cause", "causes",
            "risk", "diabetes", "metformin", "medication", "treatment", "symptom",
            "symptoms", "hirsutism", "acne", "hair",
        ],
        routing_phrases=[
            "what is pcos", "do i have pcos", "how is pcos diagnosed",
            "why does pcos", "long term", "what causes",
        ],
    ),
    AgentName.NUTRITION_COACH: AgentDefinition(
        ...
        routing_keywords=[
            ...
            "lunch", "dinner", "snack", "recipe", "calorie", "calories",
            "protein", "carb", "carbs", "carbohydrate", "fibre", "fiber",
            "sugar", "glycemic", "glycaemic", "nutrition", "vegetarian",
            "vegan", "supplement", "inositol", "vitamin", "cook", "cooking",
            "hungry", "craving", "cravings", "menu",
        ],
        routing_phrases=[
            "what should i eat", "meal plan", "diet plan", "should i eat",
            "is it okay to eat", "how many calories",
        ],
    ),
    AgentName.FITNESS_COACH: AgentDefinition(
        ...
        temperature=0.5,
        routing_keywords=[
            "exercise", "workout", "workouts", "training", "train", "gym",
            "strength", "cardio", "hiit", "yoga", "pilates", "walk", "walking",
            "run", "running", "lift", "lifting", "weights", "reps", "sets",
            "muscle", "fitness", "steps", "active", "activity", "stretch",
        ],
        routing_phrases=[
            "workout plan", "exercise plan", "should i exercise",
            "how much exercise", "training plan", "get fit",
        ],
    ),
    AgentName.MENTAL_WELLNESS_COACH: AgentDefinition(
        ...
        temperature=0.6,
        routing_keywords=[
            "stress", "stressed", "anxiety", "anxious", "depressed",
            "depression", "sad", "mood", "emotional", "cry", "crying",
            "overwhelmed", "lonely", "confidence", "self-esteem", "body",
            "image", "sleep", "insomnia", "tired", "exhausted", "burnout",
            "mental", "therapy", "cope", "coping", "frustrated", "hopeless",
            "motivation", "meditate", "meditation", "mindfulness",
        ],
        routing_phrases=[
            "i feel", "i am feeling", "i'm feeling", "i can't cope",
            "i hate my", "struggling with", "makes me feel",
        ],
    ),
    AgentName.BLOOD_REPORT_ANALYZER: AgentDefinition(
        ...
        temperature=0.2,
        routing_keywords=[
            "blood", "test", "lab", "report", "result", "results", "shbg",
            "lh", "fsh", "amh", "tsh", "prolactin", "dhea", "dheas",
            "testosterone", "glucose", "hba1c", "insulin", "homa", "lipid",
            "cholesterol", "triglyceride", "thyroid", "range", "biomarker",
            "ultrasound", "scan",
        ],
        routing_phrases=[
            "my report", "my results", "my blood test", "reference range",
            "what does this mean on my", "my levels",
        ],
    ),
    AgentName.FOOD_ANALYZER: AgentDefinition(
        ...
        temperature=0.4,
        routing_keywords=[
            "photo", "picture", "image", "plate", "dish", "meal", "scan",
            "analyse", "analyze", "calories", "macros",
        ],
        routing_phrases=[
            "this meal", "what's in this", "how many calories is this",
            "analyse this food", "picture of my",
        ],
    ),
    AgentName.HABIT_COACH: AgentDefinition(
        ...
        temperature=0.5,
        routing_keywords=[
            "habit", "habits", "routine", "streak", "consistent",
            "consistency", "discipline", "stick", "quit", "giving", "track",
            "tracking", "goal", "goals", "plan", "schedule", "reminder",
            "accountability",
        ],
        routing_phrases=[
            "how do i stick", "i keep giving up", "build a habit",
            "stay consistent", "morning routine", "get back on track",
        ],
    ),
    AgentName.CYCLE_TRACKER_ASSISTANT: AgentDefinition(
        ...
        routing_keywords=[
            ...
            "bleeding", "spotting", "flow", "late", "missed", "irregular",
            "ovulate", "ovulation", "fertile", "fertility", "conceive",
            "pregnant", "pregnancy", "ttc", "luteal", "follicular", "pms",
            "cramps", "amenorrhea", "amenorrhoea",
        ],
        routing_phrases=[
            "my period", "my cycle", "haven't had a period",
            "trying to conceive", "fertile window", "when will i ovulate",
        ],
    ),
}
